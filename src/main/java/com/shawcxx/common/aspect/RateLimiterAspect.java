...
import com.shawcxx.common.annotation.Limiter;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.shawcxx.common.annotation.Limiter)")
    ...
    public Object pointcut(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rateLimiter != null && rateLimiter.qps() > Limiter.NOT_LIMITED) {
            ...
            if (RATE_LIMITER_CACHE.get(method.getName()) != null
                ...
                throw new MyException("请求堵塞,请稍后尝试", MyResult.API_IS_BUSY);
            }
        }
